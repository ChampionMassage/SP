...
bot.on("message", async message => {
  ...
  if(cmd === `${prefix}kick`){
    ...
    .addField("Reason", kReason);
        ...
        message.guild.member(kUser).kick(kReason); kickChannel.send(kickEmbed);
  ...
  if(command === `${prefix}mute`)  {
                   ...
                   if(toMute.id === message.author.id)return message.channel.sendMessage("You cannnot mute yourself!");
                   ...
                   let role = message.guild.roles.find(r => r.name === "KoolKids Muted");
                   if(!role) {
                   try{
